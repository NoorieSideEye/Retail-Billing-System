...
class login_page:
    def __init__(self, top=None):
        ...
        top.resizable(0, 0)
        top.title("Retail Manager(ADMIN) Project By- Harnoor and Shreyan")
...
class Admin_Page:
    def __init__(self, top=None):
        top.geometry("1366x768")
        top.resizable(0, 0)
        top.title("ADMIN Mode  Project By- Harnoor and Shreyan ")
...
class Inventory:
    def __init__(self, top=None):
        top.geometry("1366x768")
        top.resizable(0, 0)
        top.title("Inventory Project By- Harnoor and Shreyan ")
...
class add_product:
    def __init__(self, top=None):
        top.geometry("1366x768")
        top.resizable(0, 0)
        top.title("Add Product Project By- Harnoor and Shreyan ")
...
class Employee:
    def __init__(self, top=None):
        top.geometry("1366x768")
        top.resizable(0, 0)
        top.title("Employee Management Project By- Harnoor and Shreyan ")
...
class add_employee:
    def __init__(self, top=None):
        top.geometry("1366x768")
        top.resizable(0, 0)
        top.title("Add Employee Project By- Harnoor and Shreyan ")
...
class Update_Employee:
    def __init__(self, top=None):
        top.geometry("1366x768")
        top.resizable(0, 0)
        top.title("Update Employee Project By- Harnoor and Shreyan ")
...
class Invoice:
    def __init__(self, top=None):
        top.geometry("1366x768")
        top.resizable(0, 0)
        top.title("Invoices Project By- Harnoor and Shreyan ")
...
class open_bill:
    def __init__(self, top=None):
        ...
        top.resizable(0, 0)
        top.title("Bill Project By- Harnoor and Shreyan ")
